                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="nombre" class="form-control" type="text" name="nombre" value="<?php echo $data['nom_editorial']; ?>" required placeholder="Nombre de la editorial">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
