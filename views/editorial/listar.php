                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="<?php echo base_url() ?>editorial/editar?id=<?php echo $editorial['id_editorial']; ?>"><i class="fas fa-edit"></i></a>
                                            ...
                                            <?php if ($editorial['estado'] == 1) { ?>
                                                <form method="post" action="<?php echo base_url() ?>editorial/darBaja" class="d-inline dar_baja">
                                                    <input type="hidden" name="id_editorial" value="<?php echo $editorial['id_editorial']; ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-white" id="my-modal-title">Registro de Editorial</h5>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="nombre" class="form-control" type="text" name="nombre" required placeholder="Nombre de la editorial">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
