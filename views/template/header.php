...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
        <a class="navbar-brand" href="<?php echo base_url(); ?>admin/listar">biblioteca UTP</a>
        <button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button>
        <!-- Navbar-->
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-capitalize" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['nombres']." ".$_SESSION['apellidos']; ?> <i class="fas fa-user fa-fw"></i></a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="<?php echo base_url(); ?>articulos">
                            <div class="sb-nav-link-icon"><i class="fas fa-file-pdf fa-lg"></i></div>
                            Artículos de Revista
                        </a>
                        <a class="nav-link active" href="<?php echo base_url(); ?>tesis">
                            <div class="sb-nav-link-icon"><i class="fas fa-book fa-lg"></i></div>
                            Tesis
                        </a>
                        ...
                        <div class="collapse" id="collapseEst" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link active" target="_blank" href="<?php echo base_url(); ?>articulos/pdf">Artículos</a>
                                <a class="nav-link active" target="_blank" href="<?php echo base_url(); ?>tesis/pdf">Tesis</a>
                            </nav>
                        </div>
                ...
                <div class="sb-sidenav-footer bg-primary">
                    <div class="small">Página Oficial: </div>
                    <a class="text-white" href="https://tubiblioteca.utp.edu.pe/" target="_blank"><i class="fa fa-university fa-lg"></i> Biblioteca</a>
                </div>
            </nav>
        </div>