                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $libro['cant_disponible']; ?></td>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>libros/editar?id=<?php echo $libro['id_recurso']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <form method="post" action="<?php echo base_url() ?>libros/eliminar" class="d-inline eliminar">
                                                    <input type="hidden" name="id_recurso" value="<?php echo $libro['id_recurso']; ?>">
                                                    <button class="btn btn-danger" type="submit"><i class="fas fa-trash-alt"></i></button>
                                            </form>
            
                                            <?php if ($libro['estado'] == 1) { ?>
                                                <form method="post" action="<?php echo base_url(); ?>libros/darBaja" class="d-inline dar_baja">
                                                    <input type="hidden" name="id_recurso" value="<?php echo $libro['id_recurso']; ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() ?>libros/registrar" method="post" id="frmLibros" class="row" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="paginas">Cantidad de página</label>
