                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input id="id" type="hidden" name="id" value="<?php echo $data['id_config']; ?>">
                                            <input id="empresa" class="form-control" type="text" name="empresa" value="<?php echo $data['empresa']; ?>" required placeholder="Nombre">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
